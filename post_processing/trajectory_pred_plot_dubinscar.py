...
model = modules.SingleBVPNet(in_features=14, out_features=1,final_layer_factor=1., hidden_features=512, num_hidden_layers=3)
model.cuda()
model.load_state_dict(
    torch.load('../logs/dubins4dParamFRS_pre40_src12_epo150_rad0017_2set_adjgrad_scaled_time/checkpoints/model_final.pth'))
